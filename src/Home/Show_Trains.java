 ...
 * @author nilad
 */
public class Show_Trains extends javax.swing.JFrame {

    /**
     * Creates new form Show_Trains
     */
    public Show_Trains() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        trainDetailsQuery = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT t FROM TrainDetails t");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Show_Trains.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private java.util.List<Home.TrainDetails> trainDetailsList;
